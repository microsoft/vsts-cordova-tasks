...
$Env:INPUT_TACOCOMMAND = $cordovaCommand
$Env:INPUT_TACOARGS = $cordovaArgs
$Env:INPUT_TACOVERSION = $cordovaVersion
$Env:INPUT_CWD = $cwd
...
Invoke-Tool -Path $node.Path -Arguments "taco-command-task.js ##vso-task-powershell" -WorkingFolder $scriptRoot -WarningPattern "(^npm |^Note: |^Build option --|^WARN: )" 
