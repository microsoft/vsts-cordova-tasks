...
if (!version) {
    try {
        ...
        if (stats && stats.isFile()) {
            ...
            version = process.env.PHONEGAP_DEFAULT_VERSION;
            console.log('Attempting to use the environment specified Phonegap version ' + version);
        }
    } catch (e) { }
}
...
if (nodeSetupPromise) {
    nodeSetupPromise.then(function () {
        ...
        commandRunner.arg(path.join(__dirname, execFile));
