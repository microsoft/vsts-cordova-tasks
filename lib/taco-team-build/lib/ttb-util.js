...
function setCachePath(newPath) {
    ...
    process.env["CORDOVA_HOME"] = path.join(moduleCache, "_cordova"); // Set platforms to cache in cache locaiton to avoid unexpected results
    process.env["PLUGMAN_HOME"] = path.join(moduleCache, "_plugman"); // Set plugin cache in cache locaiton to avoid unexpected results
}
